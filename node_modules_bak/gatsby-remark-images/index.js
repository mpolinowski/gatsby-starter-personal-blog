...
module.exports = function (_ref, pluginOptions) {
  ...
  function () {
    ...
    _regenerator.default.mark(function _callee(node, resolve, inLink, overWrites) {
      var parentNode, imagePath, imageNode, fluidResult, originalImg, fallbackSrc, srcSet, presentationWidth, srcSplit, fileName, fileNameNoExt, defaultAlt, alt, title, imageStyle, imageTag, webpFluidResult, ratio, showCaptions, rawHTML;
