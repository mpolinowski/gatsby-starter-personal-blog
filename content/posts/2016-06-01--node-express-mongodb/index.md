...
- [05 Add Bower to the Project](#05-add-bower-to-the-project)
- [06 Add Gulp to the Project](#06-add-gulp-to-the-project)
...
- [07 Add a Templating Engine - EJS](#07-add-a-templating-engine---ejs)
- [08 Adding a Page Navigation with Routing](#08-adding-a-page-navigation-with-routing)
- [09 Adding a Router for the Listview of our Book Page](#09-adding-a-router-for-the-listview-of-our-book-page)
...
- [10 Creating a Single Book by ID Route & View](#10-creating-a-single-book-by-id-route--view)
- [11 Cleaning up our routes by creating a variable for the NAV element](#11-cleaning-up-our-routes-by-creating-a-variable-for-the-nav-element)
- [12 Adding MongoDB](#12-adding-mongodb)
...
- [14 Use the MongoDB Response](#14-use-the-mongodb-response)
  - [Select Many](#select-many)
  - [Select One](#select-one)
- [15 Creating a SignIn Form on Index.ejs](#15-creating-a-signin-form-on-indexejs)
- [16 Creating the Authentication Route](#16-creating-the-authentication-route)
- [17 Adding Passport.js Middleware](#17-adding-passportjs-middleware)
- [18 Authentication with Local Strategy](#18-authentication-with-local-strategy)
- [19 Saving the User to MongoDB](#19-saving-the-user-to-mongodb)
- [20 User SignIn from mongoDB](#20-user-signin-from-mongodb)
- [21 Verifying User in DB](#21-verifying-user-in-db)
...
## 07 Add a Templating Engine - EJS
...
## 08 Adding a Page Navigation with Routing
...
## 10 Creating a Single Book by ID Route & View
...
## 11 Cleaning up our routes by creating a variable for the NAV element
